 ...
 * @category Response
 */
export declare type EnvoyOptionsRouteResponse = EnvoyResponse<EnvoyOptionsRouteResponseBody>;
/**
 * Use to type your `res` object in Envoy "remote value URL" route handlers.
 * @category Response
 */
export declare type EnvoyRemoteValueRouteResponse = EnvoyResponse<EnvoyRemoteValueRouteResponseBody>;
/**
 * Use to type your `res` object in Envoy "selected values URL" route handlers.
 * @category Response
 */
export declare type EnvoySelectedValuesRouteResponse = EnvoyResponse<EnvoySelectedValuesRouteResponseBody>;
/**
 ...
 * @category Response
 */
export declare type EnvoyValidationRouteResponse<Config> = EnvoyResponse<EnvoyValidationRouteResponseBody<Config>>;
//# sourceMappingURL=EnvoyResponse.d.ts.map