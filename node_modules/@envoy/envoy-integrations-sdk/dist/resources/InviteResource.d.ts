 ...
 */
export declare type InviteSortFields = 'name' | 'created_at' | '-name' | '-created_at';
/**
 * @category API Resource
 */
 ...
 * @category API Resource
 */
export declare type InviteRelationships = 'attendee' | 'creator' | 'employee' | 'entry' | 'flow' | 'location';
/**
 * @category API Resource
 */
export declare type InviteModel = JSONAPIModel<InviteAttributes, InviteRelationships, 'invites'>;
/**
 * @category API Resource
 */
declare type InviteCreationRequiredRelationships = 'location';
declare type InviteCreationProhibitedRelationships = 'creator';
declare type InviteCreationOptionalRelationships = Exclude<InviteRelationships, InviteCreationRequiredRelationships | InviteCreationProhibitedRelationships>;
/**
 ...
 */
export declare type InviteCreationModel = Omit<JSONAPIModel<InviteCreationAttributes, InviteRelationships, 'invites', undefined>, 'relationships'> & {
    relationships: {
...
export {};
//# sourceMappingURL=InviteResource.d.ts.map