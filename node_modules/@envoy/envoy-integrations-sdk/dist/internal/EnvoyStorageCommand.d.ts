export declare const UNIQUE_OPTIONS_DEFAULT_CHARS = "0123456789";
export declare const UNIQUE_OPTIONS_DEFAULT_SIZE = 12;
export declare const UNIQUE_NUM_OPTIONS_DEFAULT_MIN = 0;
export declare const UNIQUE_NUM_OPTIONS_DEFAULT_MAX = 9007199254740991;
 ...
 * @internal
 */
declare type EnvoyStorageCommand = EnvoyGetStorageCommand | EnvoySetStorageCommand | EnvoySetUniqueStorageCommand | EnvoySetUniqueNumStorageCommand | EnvoyUnsetStorageCommand | EnvoyListStorageCommand;
export default EnvoyStorageCommand;
//# sourceMappingURL=EnvoyStorageCommand.d.ts.map